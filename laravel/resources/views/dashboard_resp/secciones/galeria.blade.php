            ...
            <div class="row">
              <div class="col">
                <div class="text-center">
                  <button id="btnGaleria" class="btn-hover color-9 s13 img-input" data-file="Galeria" name="action">AGREGAR</button>
                </div>
                ...
                <form method="post" id="frm-gal">
                  ...
                  <div class="row">
                    <div class="input-field col s12">
                      <textarea id="txtCaption" name="txtCaption" class="materialize-textarea s13"></textarea>
                      <label for="txtCaption">Descripción*</label>
                    </div>
                  </div>
                  <div class="text-center">

                    <input id="btnSubmit" type="submit" name="submit" class="btn-hover s13" value="SUBIR"/>
                  </div>
