          ...
          <div class="col-sm-12 col-md-3">
            <div class="card">
              ...
              <div class="card-reveal">
                ...
                <div class="d-sm-flex">
                  <div class="icon-social  text-center p-2 text-light fb-color"><a href="#"><i class="fab fa-facebook-f"></i></a></div>
                  <div class="icon-social  text-center p-2 text-light instagram-color"><a href="#"><i class="fab fa-instagram"></i></a></div>
                  <div class="icon-social text-center  p-2 text-light wa-color"><a href="#"><i class="fab fa-whatsapp"></i></a></div>
                  <div class="icon-social text-center  p-2 text-light mess-color"><a href="#"><i class="fab fa-facebook-messenger"></i></a></div>
                </div>
              </div>
            </div>
          </div>
