...
<section class="dekMov mov pb-5">
  <div class="d-sm-flex justify-content-center align-items-center">
    <div class="logo-m p-5">
        <a href="{{url('/')}}">
          <img style="width:100%;" src="{{asset('images/logo.png')}}" alt="Logo White">
        </a>
    </div>
    <div class="title-m p-2">
      <h2 class="advent text-center font-weight-bold s30 text-light" style="margin:35px 0px;">{{isset($tituloSection) ? $tituloSection : 'HAZLO LOCAL'}}</h2>
    </div>
