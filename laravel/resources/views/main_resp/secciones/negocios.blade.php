<section class="pt-5 pb-5" id="panel">
  <div class="d-sm-flex justify-content-center align-items-center">
    <div class="cta-join interior advent d-sm-flex justify-content-left align-items-center">
  ...
  <h2 class="text-center font-weight-bold s25 advent active-red">NEGOCIOS REGISTRADOS</h2>
